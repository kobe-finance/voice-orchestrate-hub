...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, variant, inputSize, type, leftIcon, rightIcon, error, success, hint, ...props }, ref) => {
    ...
    // If no enhanced props are used, render basic input
    if (!leftIcon && !rightIcon && !error && !success && !hint && !isPassword) {
      return (
        <input
          type={type}
    ...
    // Render enhanced input with wrapper
    return (
