...
export const CampaignWizard = ({ isOpen, onClose, onSave }: CampaignWizardProps) => {
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => 
                    setCampaignData({
                      ...campaignData,
                      settings: { ...campaignData.settings, trackOpens: checked }
                    })
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => 
                    setCampaignData({
                      ...campaignData,
                      settings: { ...campaignData.settings, trackClicks: checked }
                    })
                  }
                />
              ...
              <div className="space-y-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2 max-h-40 overflow-y-auto">
                        {uploadedContacts.map((contact: any, index) => (
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {["Newsletter Subscribers", "Product Updates", "VIP Customers", "Trial Users"].map((list) => (
                      <div key={list} className="flex items-center space-x-2 p-3 border rounded-lg">
                        <input type="checkbox" id={list} className="rounded" />
                        <Label htmlFor={list} className="text-sm">{list}</Label>
                        <Badge variant="outline" className="ml-auto">1,234</Badge>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) => 
                      setCampaignData({ ...campaignData, isImmediate: checked })
                    }
                  />
