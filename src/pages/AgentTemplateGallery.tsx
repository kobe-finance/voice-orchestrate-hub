...
const AgentTemplateGallery = () => {
  ...
  if (showConfigForm && selectedTemplate) {
    return (
      <PageLayout
        title={`Configure Agent: ${selectedTemplate.name}`}
        description="Customize the template to match your needs"
        breadcrumbs={[...breadcrumbs, { label: "Configure Agent" }]}
        actions={
          <Button 
            variant="ghost" 
  ...
  return (
    <PageLayout
      ...
      description="Choose a template to get started quickly with pre-configured voice agents"
